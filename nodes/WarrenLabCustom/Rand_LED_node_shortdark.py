...
class LED_Run:
    def __init__(self):
        ...
        self.led_array = np.array([32,68,105,138])
        ## LED Time ON
    ...
    def led_run(self):
        ...
        rospy.logwarn(str(self.time_LED))
        ...
        # Looped through random 6 values
            ...
            rospy.logwarn('starting new led position for ')
            rospy.logwarn(str(self.time_LED))
            rospy.logwarn('position is ')
            rospy.logwarn(str(led_num))
            self.led_strip.set_led(led_num,(0,50,0)) 
    ...
    def dark_run(self):
        ...
        """
        rospy.logwarn('starting dark for ')
        rospy.logwarn(str(self.time_dark))
